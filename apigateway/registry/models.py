...
class ServiceInstance:
    ...
    def get_default_ip(self):
        for ip_address in self.ip_addresses:
            return self.ip_addresses[ip_address]
...
class ServiceInspector:
    ...
    def register_instance(self, instance: ServiceInstance):
        ...
        logger.debug(
            f"Added instance for {self.name} reachable at {instance.get_default_ip()}:{instance.get_default_port()}")
...
class ServiceRegistry:
    ...
    def __init__(self, name: str):
        logger.debug("ServiceRegistry __init__")
        self.name = name
