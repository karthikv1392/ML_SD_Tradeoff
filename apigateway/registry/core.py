import yaml
from apigateway.redis_client import init_redis_client, get_subscriber
from apigateway.monitoring.config import DMON_STRUCTURE_TOPIC
from loguru import logger

from apigateway.registry.models import ServiceRegistry, ServiceInspector, ServiceInstance, ContainerRegistry,\
    ContainerStructure
        ...
        for service in cfg:
            ...
            if len(found_containers) > 0:
                ...
                for container in found_containers:
                    service_instance = ServiceInstance(container.name, container.ip_addresses, container.ports)
