...
if args.m == "response_time":
    ...
    if args.ts_init is None or args.ts_end is None or args.days_count is None or args.day_duration is None:
        logger.error("Error. Please provide all the requested args")
        exit(1)
    services.store_workload(args.ts_init, args.ts_end, args.days_count, args.day_duration)
else:
